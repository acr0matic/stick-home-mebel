<?php
// Мета-теги
$title = "Белый современный гардероб в прихожую";
$description = "Для фасада данного гардероба были использованы пленка ПВХ и МДФ. Для светлой прихожей был выбран не менее светлый цвет и для гардероба. Фурнитура использована от компании Blum.";
$keywords = "Гардерод, белый, в прихожую, ПВХ, МДФ, на заказ, москва и область";
        ...
        <div class="product__row row">
          ...
          <div class="column">
            <div class="product-text">
              ...
              <p class="product-text__description paragraph">Для фасада данного гардероба были использованы <strong>пленка ПВХ</strong> и <strong>МДФ</strong>. Для светлой прихожей был выбран не менее светлый цвет и для гардероба. Фурнитура использована от компании <strong>Blum</strong>.</p>
            </div>
            <!-- /.product-text -->
            ...
            <div class="product-photo">
              ...
              <div class="product-photo__content product-gallery__row">
                ...
                <div class="product-gallery__secondary image-wrapper border-br-tl">
                  <img src="<?php $_SERVER['DOCUMENT_ROOT']?>/img/portfolio/wardbore_1/2.jpg" alt="" class="product-gallery__image image-wrapper__image border-br-tl">
                </div>
                <!-- /.work-gallery__secondary -->

                <div class="product-gallery__secondary image-wrapper border-br-tl">
                  <img src="<?php $_SERVER['DOCUMENT_ROOT']?>/img/portfolio/wardbore_1/3.jpg" alt="" class="product-gallery__image image-wrapper__image border-br-tl">
                </div>
                <!-- /.work-gallery__secondary -->

                <div class="product-gallery__secondary image-wrapper border-br-tl">
                  <img src="<?php $_SERVER['DOCUMENT_ROOT']?>/img/portfolio/wardbore_1/4.jpg" alt="" class="product-gallery__image image-wrapper__image border-br-tl">
                </div>
                <!-- /.work-gallery__secondary -->
              </div>
              <!-- /.work-gallery__row -->
