<?php
// Мета-теги
$title = "Белая кухня с темной пластиковой столещницей";
$description = "В качестве фасада использована пленка ПВХ. Столещница сделана из пластика и покрашена в темные тона, для большего контраста цветов. Фурнитура использована от компании Blum.";
        ...
        <div class="product__row row">
            ...
            <div class="product__gallery product-gallery">
              <div class="product-gallery__primary image-wrapper border-br-tl">
                <a data-fslightbox href="<?php $_SERVER['DOCUMENT_ROOT']?>/img/portfolio/kitchen_1/1.jpg">
                  <img src="<?php $_SERVER['DOCUMENT_ROOT']?>/img/portfolio/kitchen_1/1.jpg" alt="" class="product-gallery__image image-wrapper__image border-br-tl">
                </a>
              </div>
              <!-- /.work-gallery__main -->
            </div>
          ...
          <div class="column">
            <div class="product-text">
              ...
              <p class="product-text__description paragraph">В качестве фасада использована <strong>пленка ПВХ</strong>. Столещница сделана из <strong>пластика</strong> и покрашена в темные тона, для большего контраста цветов. Фурнитура использована от компании <strong>Blum</strong>.</p>
            </div>
            <!-- /.product-text -->
            ...
            <div class="product-photo">
              ...
              <div class="product-photo__content product-gallery__row">
                ...
                <div class="product-gallery__secondary image-wrapper border-br-tl">
                  <img src="<?php $_SERVER['DOCUMENT_ROOT']?>/img/portfolio/kitchen_1/2.jpg" alt="" class="product-gallery__image image-wrapper__image border-br-tl">
                </div>
                <!-- /.work-gallery__secondary -->

                <div class="product-gallery__secondary image-wrapper border-br-tl">
                  <img src="<?php $_SERVER['DOCUMENT_ROOT']?>/img/portfolio/kitchen_1/3.jpg" alt="" class="product-gallery__image image-wrapper__image border-br-tl">
                </div>
                <!-- /.work-gallery__secondary -->

                <div class="product-gallery__secondary image-wrapper border-br-tl">
                  <img src="<?php $_SERVER['DOCUMENT_ROOT']?>/img/portfolio/kitchen_1/4.jpg" alt="" class="product-gallery__image image-wrapper__image border-br-tl">
                </div>
                <!-- /.work-gallery__secondary -->
              </div>
              <!-- /.work-gallery__row -->
