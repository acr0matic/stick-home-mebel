    ...
    <section id="materials">
      <div class="container">
        ...
        <div class="materials">
          ...
          <div class="material material--action border-br-tl">
      ...
      <div class="modal__wrapper">
        ...
        <div class="modal__container border-br-tl" role="dialog" aria-modal="true">
          ...
          <main class="modal__content" id="modal-1-content">
            ...
            <p class="paragraph">Далеко-далеко за словесными горами в стране гласных и согласных живут рыбные тексты. Заголовок диких даль семь дал свое большого послушавшись ведущими одна?</p>
            <p class="paragraph">Далеко-далеко за словесными горами в стране гласных и согласных живут рыбные тексты. Вопроса злых даже оксмокс свое несколько подзаголовок меня но великий свою власти гор возвращайся, рыбного строчка вдали бросил предупредила не. Бросил взобравшись
              злых собрал наш пустился жаренные? Подзаголовок родного, вершину он lorem, маленький точках переулка деревни переписали вскоре текст предупреждал.</p>
          </main>
        </div>
        <!-- /.modal__container -->
      </div>
